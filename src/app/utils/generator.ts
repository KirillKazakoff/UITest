...
const generateDate = ({
    ...
    const getPart = (part: any) => (typeof part === 'function' ? part(random) : part);
...
export const globalSalesValues = {
    ...
    saleDate: ({ random }: any) => generateDate({
        random,
        year: 2016,
...
export const employeeValues = {
    ...
    birthDate: ({ random }: any) => generateDate({
        random,
...
export const employeeTaskValues = {
    ...
    startDate: ({ random }: any) => generateDate({
        random,
        year: 2016,
    }),
    dueDate: ({ random, record }: any) => generateDate({
        random,
        year: 2016,
